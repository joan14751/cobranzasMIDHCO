  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-950 font-sans antialiased">
      ...
      <div className="flex w-full lg:w-1/2 xl:w-5/12 items-center justify-center p-6 sm:p-12 bg-slate-950">
        <div className="w-full max-w-md rounded-3xl border border-slate-800/80 bg-slate-900/50 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-blue-600/25 hover:from-blue-500 hover:to-indigo-500 active:scale-[0.98] disabled:opacity-60 transition-all duration-200"
            >
              {loading ? (
                <>
